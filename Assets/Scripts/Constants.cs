...
public static class Constants
{
    ...
    private static Dictionary<SquareTypes, Color> squareColors = new Dictionary<SquareTypes, Color>
        {
    ...
    public static Dictionary<SquareTypes, Color> GetSquareColors =>  squareColors;
}
